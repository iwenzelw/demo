...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='book',
            name='showcase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='demo.Showcase'),
        ),
        migrations.AlterField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='demo.Country'),
        ),
        migrations.AlterField(
            model_name='country',
            name='code',
        ...
        migrations.AlterField(
            model_name='country',
            name='continent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='demo.Continent'),
        ),
        migrations.AlterField(
            model_name='country',
            name='description',
        ...
        migrations.AlterField(
            model_name='showcase',
            name='country',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='demo.Country'),
        ),
        migrations.AlterField(
            model_name='showcase',
            name='country2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='showcase_country2_set', to='demo.Country', verbose_name='Django Select 2'),
        ),
        migrations.AlterField(
            model_name='showcase',
            name='help_text',
        ...
        migrations.AlterField(
            model_name='showcase',
            name='raw_id_field',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='showcase_raw_set', to='demo.Country'),
        ),
        migrations.AlterField(
            model_name='showcase',
            name='readonly_field',
