...
class Country(models.Model):
    continent = models.ForeignKey(Continent, null=True, on_delete=models.DO_NOTHING)
    name = models.CharField(max_length=256)
...
class Showcase(models.Model):
    ...
    country2 = models.ForeignKey(Country, null=True, blank=True, related_name='showcase_country2_set',
                                 on_delete=models.DO_NOTHING, verbose_name='Django Select 2')
    raw_id_field = models.ForeignKey(Country, null=True, blank=True, related_name='showcase_raw_set', on_delete=models.DO_NOTHING)
...
class Movie(models.Model):
    showcase = models.ForeignKey(Showcase, on_delete=models.DO_NOTHING)
